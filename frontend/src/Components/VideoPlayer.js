...
function VideoPlayer() {
    ...
    const handlePlayerReady = (player) => {
        ...
        player.on('timeupdate', () => {
            localStorage.setItem(`video-${id}`, player.currentTime());
        });
        ...
        player.on('ended', () => {
            // Mark this video as watched when it ends
            localStorage.setItem(`video-watched-${id}`, true);
        });
    ...
    return (
        <VideoPlayerStyled>
            <div className="back">
                <Link to={'/videos'}><i className="fas fa-arrow-left"></i>Back to Videos</Link>
            </div>
            <div className="video-container" ref={videoConRef}>
                <VideoJS options={videoOptions} onReady={handlePlayerReady} />
            </div>
